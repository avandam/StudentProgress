...
#nullable enable
    ...
    public ProgressUpdate(Student student, StudentGroup group, string? feedback, Feeling progressFeeling, DateTime date, ProgressStatus progressStatus)
    {
    ...
    public Result Update(Feeling feeling, DateTime date, string? feedback, ProgressStatus progressStatus)
    {
